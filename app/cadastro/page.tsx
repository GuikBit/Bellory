...
import { Building2, MapPin, CreditCard, CheckCircle2, KeyRound, EyeOff, Eye, Check, Palette, CheckCheck } from "lucide-react"
...
export default function Cadastro() {
  ...
  const isCurrentStepValid = () => {
    if (activeStep === 0) {
      ...
      const values = getValues()
      return !!(values.login && values.senha)
    }
    return true
  }
  ...
  const StepperHeader = () => {
    return (
      <div className="flex items-center justify-between md:px-4 md:my-4 my-4">
          ...
          return (
            <div key={step.id} className="flex items-center w-full">
                ...
                <div
                  className={classNames(
                    "md:w-12 w-10 md:h-12 h-10 rounded-full flex items-center justify-center transition-all duration-300",
                    {
                      ...
                      "bg-accent text-accent-foreground ring-4 ring-accent/20 text-white": isActive && !isCompleted,
                      "bg-muted text-muted-foreground": !isActive && !isCompleted,
                    },
                  )}
                  style={{filter: 'drop-shadow(2px 2px 2px #11111140)'}}
                >
                  {isCompleted ? <Check className="w-6 h-6" size={20} style={{filter: 'drop-shadow(2px 2px 2px #11111140)'}} /> : <StepIcon className="md:w-6 w-4.5 md:h-6 h-4.5" style={{filter: 'drop-shadow(2px 2px 2px #11111140)'}} />}
                </div>
                <span
                  className={classNames("text-xs mt-2 text-center font-medium transition-colors duration-300", "hidden md:block", {
              ...
              {index < steps.length - 1 && (
                <div
                  className={classNames("h-0.5 flex-1 mx-2 transition-colors duration-300", {
            ...
            {activeStep === 0 && (
              <div>
                <div className="md:py-8 py-2">
                  <div className="flex items-center gap-3 md:mb-8 mb-4 px-4" style={{filter: 'drop-shadow(2px 2px 2px #11111140)'}}>
                    <div className="text-center w-full">
                      <h3 className="md:text-xl text-lg font-semibold text-foreground pb-1">Dados da Empresa</h3>
                      <p className="md:text-sm text-xs text-muted-foreground">Informações legais do seu estabelecimento</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <InputMask
                            ...
                            className={`w-full p-2 border rounded-lg ${errors.cnpj ? "border-destructive" : "border-border"}`}
                          />
                        )}
                      />
                      {errors.cnpj && <small className="text-destructive mx-3">{errors.cnpj.message}</small>}
                    </div>
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <InputText
                            ...
                            className={`w-full p-2 border rounded-lg ${errors.razaoSocial ? "border-destructive" : "border-border"}`}
                          />
                        )}
                      />
                      {errors.razaoSocial && <small className="text-destructive mx-3">{errors.razaoSocial.message}</small>}
                    </div>
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <InputText
                            ...
                            className={`w-full p-2 border rounded-lg ${errors.nomeFantasia ? "border-destructive" : "border-border"}`}
                          />
                        )}
                      />
                      {errors.nomeFantasia && <small className="text-destructive mx-3">{errors.nomeFantasia.message}</small>}
                    </div>
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <InputText
                            ...
                            className={`w-full p-2 border rounded-lg ${errors.email ? "border-destructive" : "border-border"}`}
                          />
                        )}
                      />
                      {errors.email && <small className="text-destructive mx-3">{errors.email.message}</small>}
                    </div>
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <InputMask
                            ...
                            className={`w-full p-2 border rounded-lg ${errors.telefone ? "border-destructive" : "border-border"}`}
                          />
                        )}
                      />
                      {errors.telefone && <small className="text-destructive mx-3">{errors.telefone.message}</small>}
                    </div>
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <InputText
                            ...
                            className={`w-full p-2 border rounded-lg ${errors.nomeResponsavel ? "border-destructive" : "border-border"}`}
                          />
                        )}
                      />
                      {errors.nomeResponsavel && (
                        <small className="text-destructive mx-3">{errors.nomeResponsavel.message}</small>
                      )}
                    </div>
                    ...
                    <div className="flex flex-col">
                      ...
                      {errors.emailResponsavel && (
                        <small className="text-destructive mx-3">{errors.emailResponsavel.message}</small>
                      )}
                    </div>
                    ...
                    <div className="flex flex-col">
                      ...
                      {errors.telefoneResponsavel && (
                        <small className="text-destructive mx-3">{errors.telefoneResponsavel.message}</small>
                      )}
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <InputMask
                            ...
                            className={`w-full p-2 border rounded-lg ${errors.cep ? "border-destructive" : "border-border"}`}
                          />
                        )}
                      />
                      {errors.cep && <small className="text-destructive mx-3">{errors.cep.message}</small>}
                    </div>
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <Dropdown
                            ...
                            className={`w-full p-2 relative border ${errors.estado ? "" : ""}`}
                          />
                        )}
                      />
                      {errors.estado && <small className="text-destructive mx-3">{errors.estado.message}</small>}
                    </div>

                    <div className="flex flex-col md:col-span-2">
                      <label htmlFor="rua" className="text-sm font-medium text-foreground mb-1 mx-3">
                        Rua <span className="text-destructive mx-3">*</span>
                      </label>
                      <Controller
                        name="rua"
                        control={control}
                        ...
                        render={({ field }) => (
                          <InputText
                            ...
                            className={`w-full p-2 border rounded-lg ${errors.rua ? "border-destructive" : "border-border"}`}
                          />
                        )}
                      />
                      {errors.rua && <small className="text-destructive mx-3">{errors.rua.message}</small>}
                    </div>

                    <div className="flex flex-col">
                      <label htmlFor="numero" className="text-sm font-medium text-foreground mb-1 mx-3">
                        Número <span className="text-destructive mx-3">*</span>
                      </label>
                      <Controller
                        name="numero"
                        control={control}
                        ...
                        render={({ field }) => (
                          <InputText
                            ...
                            {...field}
                            placeholder="123"
                            className={`w-full p-2 border rounded-lg ${errors.numero ? "border-destructive" : "border-border"}`}
                          />
                        )}
                      />
                      {errors.numero && <small className="text-destructive mx-3">{errors.numero.message}</small>}
                    </div>
                    ...
                    <div className="flex flex-col">
                      <label htmlFor="bairro" className="text-sm font-medium text-foreground mb-1 mx-3">
                        Bairro <span className="text-destructive mx-3">*</span>
                      </label>
                      <Controller
                        name="bairro"
                        control={control}
                        ...
                        render={({ field }) => (
                          <InputText
                            ...
                            className={`w-full p-2 border rounded-lg ${errors.bairro ? "border-destructive" : "border-border"}`}
                          />
                        )}
                      />
                      {errors.bairro && <small className="text-destructive mx-3">{errors.bairro.message}</small>}
                    </div>

                    <div className="flex flex-col">
                      <label htmlFor="cidade" className="text-sm font-medium text-foreground mb-1 mx-3">
                        Cidade <span className="text-destructive mx-3">*</span>
                      </label>
                      <Controller
                        name="cidade"
                        control={control}
                        ...
                        render={({ field }) => (
                          <InputText
                            ...
                            className={`w-full p-2 border rounded-lg ${errors.cidade ? "border-destructive" : "border-border"}`}
                          />
                        )}
                      />
                      {errors.cidade && <small className="text-destructive mx-3">{errors.cidade.message}</small>}
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="md:py-8 py-2">
                  <div className="flex items-center gap-3 md:mb-8 mb-4 px-4" style={{filter: 'drop-shadow(2px 2px 2px #11111140)'}}>
                    <div className="text-center w-full">
                      ...
                      <p className="md:text-sm text-xs text-muted-foreground">Cadastre o acesso administrativo do seu estabelecimento</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                    <div className="flex flex-col">
                      <label htmlFor="login" className="text-sm font-medium text-foreground mb-1 mx-3">
                        Login <span className="text-destructive mx-3">*</span>
                      </label>
                      <Controller
                        name="login"
                        control={control}
                        ...
                        render={({ field }) => (
                          <InputText
                            ...
                            className={`w-full p-2 border rounded-lg ${errors.login ? "border-destructive" : "border-border"}`}
                          />
                        )}
                      />
                    ...
                    <div className="flex flex-col relative">
                      <label htmlFor="senha" className="text-sm font-medium text-foreground mb-1 mx-3">
                        Senha <span className="text-destructive mx-3">*</span>
                      </label>
                        ...
                        render={({ field }) => (
                          <div className="relative">
                            <InputText
                              ...
                              className={classNames("w-full p-2 pr-10 border rounded-lg transition-colors", {
                      ...
                      {errors.senha && (
                        <small className="text-destructive text-sm whitespace-pre-line mx-3">{errors.senha.message}</small>
                      )}
                    </div>
                    <div className="flex flex-col relative">
                      <label htmlFor="senha" className="text-sm font-medium text-foreground mb-1 mx-3">
                        Confirmação da Senha <span className="text-destructive mx-3">*</span>
                      </label>
                        ...
                        render={({ field }) => (
                          <div className="relative">
                            <InputText
                              ...
                              placeholder="Digite uma senha forte"
                              className={classNames("w-full p-2 pr-10 border rounded-lg transition-colors", {
                                "border-destructive": errors.confSenha,
                                "border-border": !errors.confSenha,
                              })}
                            />
                            <button
                              type="button"
                      ...
                      {errors.confSenha && (
                        <small className="text-destructive text-sm whitespace-pre-line mx-3">{errors.confSenha.message}</small>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="md:py-8 py-2">
                  <div className="flex items-center gap-3 md:mb-8 mb-4 px-4" style={{filter: 'drop-shadow(2px 2px 2px #11111140)'}}>
                    <div className="text-center w-full">
                      ...
                      <p className="md:text-sm text-xs text-muted-foreground">Seleciono o tema e fontes que seram usados no sistema</p>
                    </div>
                  </div>
                  <p className="text-muted-foreground">Adicione o conteúdo da etapa 3 aqui</p>
                </div>
              </div>
            )}
            {activeStep === 4 && (
              <div>
                {/* <div className="py-8">
                  <div className="flex items-center gap-3 mb-8" style={{filter: 'drop-shadow(2px 2px 2px #11111140)'}}>
                    <div className="w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center">
                      <Building2 className="w-6 h-6 text-accent" />
                    </div>
                    <div>
                      <h3 className="text-xl font-semibold text-foreground">Etapa 4</h3>
                      <p className="text-sm text-muted-foreground">Conteúdo da etapa 4</p>
                    </div>
                  </div> */}
                <div className="md:py-8 py-2">
                  <div className="flex items-center gap-3 md:mb-8 mb-4 px-4" style={{filter: 'drop-shadow(2px 2px 2px #11111140)'}}>
                    <div className="text-center w-full">
                      <h3 className="md:text-xl text-lg font-semibold text-foreground pb-1">Pagamento</h3>
                      <p className="md:text-sm text-xs text-muted-foreground">Escolha seu plano e forma de pagamento</p>
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-1 grid-cols-2 gap-2">
                      <div className="flex flex-col">
                        <label htmlFor="plano" className="text-sm font-medium text-foreground mb-1 mx-3">
                          Plano <span className="text-destructive mx-3">*</span>
                        </label>
                        <Controller
                          name="plano"
                          control={control}
                      ...
                      <div className="flex flex-col">
                        <label htmlFor="formaPagamento" className="text-sm font-medium text-foreground  mb-1 mx-3">
                          Forma de Pagamento <span className="text-destructive mx-3">*</span>
                        </label>
                        <Controller
                          name="formaPagamento"
                          control={control}
                ...
                <div className="md:py-8 py-2">
                  <div className="flex items-center gap-3 md:mb-8 mb-4 px-4" style={{filter: 'drop-shadow(2px 2px 2px #11111140)'}}>
                    <div className="text-center w-full">
                      ...
                      <p className="md:text-sm text-xs text-muted-foreground">Confira as principais informações para contratação</p>
                    </div>
                  </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-7xl mx-auto">
          <Card className="p-2 sm:p-8 mt-4 bg-card border border-border shadow-lg rounded-2xl">
            <div className="text-center md:mb-10 mt-2 md:mt-0" style={{filter: 'drop-shadow(2px 2px 2px #11111140)'}}>
              ...
              <p className="md:text-lg text-sm text-muted-foreground">Complete as informações abaixo para criar sua conta</p>
            </div>
