  ...
  private async flush(): Promise<void> {
    ...
    try {
      const headers = {
        ...
        'X-API-Key': 'bly_qjprBQgq8TF2TIoC7Fa7Hqp0tJfa8zMzwh7eJ-aRsjM',
      }
      ...
      if (typeof navigator !== 'undefined' && navigator.sendBeacon) {
        ...
        if (sent) return
        // sendBeacon não suporta headers customizados, então cai no fetch abaixo
      }

      console.warn('URL de envio do tracker: ', this.config.apiUrl)
