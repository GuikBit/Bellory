        ...
        >
          <div className="text-center mb-16">
            <h3 className="font-serif text-4xl sm:text-5xl font-bold text-[#2a2420] mb-4">
              Veja a <span className="text-[#8b3d35]">transformação</span>
            </h3>
            <p className="text-xl text-[#5a7d71]">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl border-2 border-[#d8ccc4]">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 rounded-full flex items-center justify-center bg-[#FFE2E2]">
                  <X className="w-6 h-6 text-[#d15847]" />
                </div>
                <h4 className="text-2xl font-bold" style={{ color: '#2a2420' }}>{beforeAfter.before.title}</h4>
              </div>
              <ul className="space-y-4">
                {beforeAfter.before.problems.map((problem, index) => (
                  ...
                  >
                    ...
                    />
                    <span className="leading-relaxed" style={{ color: '#4f6f64' }}>{problem.text}</span>
                  </motion.li>
                ))}
              </ul>
            </div>
        ...
        >
          <div className="inline-flex flex-col sm:flex-row items-center gap-6 p-10 bg-white rounded-3xl shadow-2xl border border-[#d8ccc4]">
            <div className="text-left">
              <h4 className="text-2xl sm:text-3xl font-bold mb-2" style={{ color: '#2a2420' }}>
                Quer ver tudo funcionando ao vivo?
              </h4>
              <p className="text-lg" style={{ color: '#4f6f64' }}>
